...
public class AES_GetBusa_Request_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public AES_GetBusa_Request_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        AES_GetBusa_Request bean = (AES_GetBusa_Request) value;
        ...
        javax.xml.namespace.QName propQName;
        {
          ...
          propQName = QName_0_2;
          propValue = bean.getTradingPartner();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
          ...
          propQName = QName_0_6;
          propValue = bean.getServiceVersion();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
