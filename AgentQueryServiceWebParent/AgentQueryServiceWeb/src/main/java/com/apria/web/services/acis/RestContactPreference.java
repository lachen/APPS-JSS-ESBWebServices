 ...
 * @author BRANGANA
 */
@Path(value = "/contactpreferencelist")
public class RestContactPreference {

	@GET
	@Path(value = "/xml")
	@Produces(MediaType.APPLICATION_XML)
	public ContactPreferenceResponse getAgentListXml(
		@QueryParam(value = "acisid") String acisId) throws Exception {

		return getContactPreferenceList(acisId);
	}
	...
	public ContactPreferenceResponse getContactPreferenceList(
		...
		return service.getContactPreferenceList(request);
	}
}
