 ...
 * @author BRANGANA
 */
@Path(value = "/productpreferencelist")
public class RestProductPreference {

	@GET
	@Path(value = "/xml")
	@Produces(MediaType.APPLICATION_XML)
	public ProductPreferenceResponse getAgentListXml(
		@QueryParam(value = "acisid") String acisId) throws Exception {

		return getProductPreferenceList(acisId);
	}
	...
	public ProductPreferenceResponse getProductPreferenceList(
		...
		return service.getProductPreferenceList(request);
	}
}
